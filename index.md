...
Conformance of an evidence record should not be confused with validation of its scientific conclusions. A conformant manifest can establish that objects, versions, contributors, and declared relationships are machine-readable and traceable; it cannot certify methodological quality, absence of bias, reproducibility, or the validity of a downstream claim.

Quality appraisal should therefore remain separate from evidence publication. An evidence record may expose producer-declared quality-control information and provenance while becoming the subject of zero, one, or multiple independently versioned assessments. Each assessment should identify its subject, protocol, evidence basis, assessors, review status, limitations, and lifecycle, and declare its purpose when making a fitness-for-purpose conclusion. Assessments may use different protocols, address different purposes, or disagree; they should remain attributable and inspectable rather than being combined into a universal trust score. TRUST.md v0.4 provides one experimental human- and machine-readable implementation of this pattern for exact evidence subjects and contextual assessments {cite}`huzard2026trustmd`. It is presented as a pilot example, not as a certification system or required component of the evidence layer.

Making such assessments discoverable could guide evidence reuse without treating citations, reuse frequency, prestige, or popularity as evidence of quality.
